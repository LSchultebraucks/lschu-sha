...
export declare const rightShiftLogical: (word: string, d: number) => string;
...
export declare const createInitialWords: (wArr: string[], bitSize: number) => string[];
export declare const hashRound: (hashVariables: string[], k: string, w: string, bitSize?: number) => string[];
